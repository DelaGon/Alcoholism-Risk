...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($matchedRows) {
        ...
        for ($i = 0; $i < min(3, count($matchedRows)); $i++) {
            ...
            if ($row['risk_level'] == 'ความเสี่ยงต่ำ') {
                $riskClass = 'low-risk';
            } elseif ($row['risk_level'] == 'ความเสี่ยงปานกลาง') {
                $riskClass = 'moderate-risk';
            } elseif ($row['risk_level'] == 'ความเสี่ยงสูง') {
                $riskClass = 'high-risk';
            } elseif ($row['risk_level'] == 'ความเสี่ยงสูงมาก') {
                $riskClass = 'very-high-risk';
            }elseif ($row['risk_level'] == 'ไม่มีความเสี่ยง') {
                $riskClass = 'no-risk';
            }
            ...
            echo "<div class='risk-level'>ระดับความเสี่ยง: " . $row["risk_level"] . "</div>";
